	...
	render(){
		...
		var Iframe = React.createClass({     
			render: function() {
				return(         
					<div>          
					<iframe src={this.props.src} title="Video" height={this.props.height} width={this.props.width} scrolling="no" frameBorder="0" allowFullScreen="true"></iframe>         
					</div>
					)
			}
		});
		...
		return (
			...
			<Modal.Body>
			<Iframe src={this.state.link} height="500" width="640" frameBorder="0" allowFullscreen="true" />
			</Modal.Body>
			<Modal.Footer>
